...
import (
	...
	goonvif "github.com/jjbarbosa7/onvif"
	"github.com/jjbarbosa7/onvif/device"
	sdk "github.com/jjbarbosa7/onvif/sdk/device"
...
func main() {
	...
	if err != nil {
		...
		// You could use https://github.com/jjbarbosa7/onvif/gosoap for pretty printing response
